...
class Dataset():
    ...
    def update_env(self,index):
        ...
        if self.env_info[index]["type"] == "image":
            ...
            # Propeller velocity
            self.v_cond_full_res[index,0:1,int(self.resolution_factor*object_x-object_h//2):int(self.resolution_factor*object_x-object_h//2+object_h),int(self.resolution_factor*object_y-object_w//2):int(self.resolution_factor*object_y-object_w//2+object_w)] = (2+flow_v)*self.propeller
            self.v_cond_full_res[index,1:2,int(self.resolution_factor*object_x-object_h//2):int(self.resolution_factor*object_x-object_h//2+object_h),int(self.resolution_factor*object_y-object_w//2):int(self.resolution_factor*object_y-object_w//2+object_w)] = (2+flow_v)*self.propeller

            # Object boundary
            # self.v_cond_full_res[0,0,25:35,20:25]=1
